...
public class SelectEduYearStu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_edu_year_stu);
        ...
        eduYearRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(SelectEduYearStu.this, android.R.layout.simple_list_item_1, eduYearList);
        ...
        NextBtn.setOnClickListener(v -> {
            if(SelectedYear !=null && !SelectedYear.equals("Select Education Year") && SelectedClass != null && !SelectedClass.equals("Select Classroom")){
                Intent intent=new Intent(SelectEduYearStu.this, StudentListActivity.class);
