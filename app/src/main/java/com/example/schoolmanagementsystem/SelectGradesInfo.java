...
public class SelectGradesInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_grades_info);
        ...
        eduYearRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(SelectGradesInfo.this, android.R.layout.simple_list_item_1, eduYearList);
                                ...
                                classRef.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        if (snapshot.exists()) {
                                            ...
                                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(SelectGradesInfo.this, android.R.layout.simple_list_item_1, classList);
                                                        ...
                                                        typeRef.addValueEventListener(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                                ...
                                                                if (snapshot.exists()) {
                                                                    ...
                                                                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(SelectGradesInfo.this, android.R.layout.simple_list_item_1, gradeTypeList);
                                                                                ...
                                                                                subjectRef.addValueEventListener(new ValueEventListener() {
                                                                                    ...
                                                                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                                                        ...
                                                                                        if (snapshot.exists()) {
                                                                                            ...
                                                                                            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(SelectGradesInfo.this, android.R.layout.simple_list_item_1, subjectList);
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (SelectedYear != null && !SelectedYear.equals("Select Education Year") && SelectedClass != null && !SelectedClass.equals("Select Classroom") && SelectedType != null && !SelectedType.equals("Select Exam") && SelectedSubject != null && !SelectedSubject.equals("Select Subject")) {
                    Intent intent = new Intent(SelectGradesInfo.this, EnterGradesActivity.class);
